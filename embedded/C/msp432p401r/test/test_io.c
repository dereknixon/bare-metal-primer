...
void test_io_configure_pin_as_output_handles_P7(void)
{
    register_set_bits8_Expect(&P7->DIR, BIT0);

    io_configure_pin_as_output(P7, BIT0);
}
...
void test_io_set_output_pin_handles_P7(void)
{
    register_set_bits8_Expect(&P7->OUT, BIT0);

    io_set_output_pin(P7, BIT0);
}
...
void test_io_clear_output_pin_handles_P7(void)
{
    register_clear_bits8_Expect(&P7->OUT, BIT0);

    io_clear_output_pin(P7, BIT0);
}
...
void test_io_toggle_output_pin_handles_P7(void)
{
    register_toggle_bits8_Expect(&P7->OUT, BIT0);

    io_toggle_output_pin(P7, BIT0);
}
...
void test_io_configure_pin_as_input_handles_P7(void)
{
    register_clear_bits8_Expect(&P7->DIR, BIT0);

    io_configure_pin_as_input(P7, BIT0);
}
...
void test_io_read_input_pin_returns_false_when_pin_is_cleared_on_P7(void)
{
    register_read8_ExpectAndReturn(&P7->IN, 0);

    bool actual = io_read_input_pin(P7, BIT0);
...
void test_io_read_input_pin_returns_true_when_pin_is_set_on_P7(void)
{
    register_read8_ExpectAndReturn(&P7->IN, 1);
...
void test_io_configure_pin_for_peripheral_in_primary_mode_handles_P1(void)
{
    register_set_bits8_Expect(&P1->SEL0, BIT0);
    register_clear_bits8_Expect(&P1->SEL1, BIT0);

    io_configure_pin_for_peripheral_in_primary_mode(P1, BIT0);
}

void test_io_configure_pin_for_peripheral_in_primary_mode_handles_P2(void)
{
    register_set_bits8_Expect(&P2->SEL0, BIT0);
    register_clear_bits8_Expect(&P2->SEL1, BIT0);

    io_configure_pin_for_peripheral_in_primary_mode(P2, BIT0);
}

void test_io_configure_pin_for_peripheral_in_primary_mode_handles_P7(void)
{
    register_set_bits8_Expect(&P7->SEL0, BIT0);
    register_clear_bits8_Expect(&P7->SEL1, BIT0);

    io_configure_pin_for_peripheral_in_primary_mode(P7, BIT0);
}

void test_io_configure_pin_for_peripheral_in_primary_mode_does_not_handle_other_ports(void)
{
    DIO_PORT_Odd_Interruptable_Type an_unknown_port = { 0 };
    const DIO_PORT_Odd_Interruptable_Type expected_port = { 0 };;

    io_configure_pin_for_peripheral_in_primary_mode(&an_unknown_port, BIT0);
